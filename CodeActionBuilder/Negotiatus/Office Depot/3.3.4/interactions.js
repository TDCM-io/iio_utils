module.exports = async function (input) {
  ...
  var returnedData = await extractorContext.execute(async function (a) {
    const utils = new window.__Utils(this, "NEG 3.3.4.");
  ...
  await extractorContext.execute(function (a) {
  ...
  const data = await extractorContext.extractData({
    "fields": [
      {
        "id": "79f26368-570b-4db7-8298-87ac1234b7d3",
        "name": "auth_status",
        "type": "AUTO",
      ...
      {
        "id": "79f26368-570b-4db7-8298-87ac4321b7d4",
        "name": "auth_message",
        "type": "AUTO",
